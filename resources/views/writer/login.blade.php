...
<div class="w-svw h-svh flex justify-center items-center bg-gray-200">
    <div class="w-2/6 h-5/6 bg-white rounded-xl flex flex-col items-center justify-start">
        <h1 class="text-3xl pt-8">writer login</h1>
        <form action="{{route('writer.login')}}" method="post" class="w-5/6 flex flex-col items-end justify-start mt-10">
            @csrf
        ...
        <a href="{{route('writer.register.form')}}" class="mt-10">ثبت نام نکرده اید؟</a>
    </div>
</div>
</body>
</html>
